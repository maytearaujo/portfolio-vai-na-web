      ...
      <S.Cards>
        <S.Card>
          ...
          <div>
            ...
            <p>
              Projeto de conclusão do 1º módulo do curso de desenvolvimento web
              para mulheres realizado pelo Vai Na Web.
            </p>
          </div>
          <S.DivSocialMediaProjetos>
            ...
            <a
              href="https://github.com/maytearaujo/Fantastika.git"
              target="_blank"
            >
        ...
        <S.Card>
          ...
          <S.DivSocialMediaProjetos>
            ...
            <a
              href="https://github.com/maytearaujo/doceria-borcelle.git"
              target="_blank"
            >
              <img src={Github} alt="Projeto Github" />
            </a>
        ...
        <S.Card>
          ...
          <div>
            <h4>HTML, CSS, React, Styled Components.</h4>
            <p>
              Projeto desenvolvido durante as aulas de React no curso de
              desenvolvimento web para mulheres realizado pelo Vai na Web.
            </p>
          ...
          <S.DivSocialMediaProjetos>
            ...
            <a
              href="https://github.com/maytearaujo/cartoon-network.git"
              target="_blank"
            >
              <img src={Github} alt="Projeto Github" />
            </a>
